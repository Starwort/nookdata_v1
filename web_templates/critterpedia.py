        ...
        mdc.Card(
            content=dom.ElementGroup(
                dom.ContentDivision(
                    ...
                    dom.Span("0 / 80", class_="obtained", id="obtained_bugs"),
                    dom.Span("(0 / 80)", class_="modelled", id="modelled_bugs"),
        ...
        mdc.Card(
            content=dom.ElementGroup(
                dom.ContentDivision(
                    ...
                    dom.Span("0 / 80", class_="obtained", id="obtained_fish"),
                    dom.Span("(0 / 80)", class_="modelled", id="modelled_fish"),
                    class_="critter-table-title",
                ),
                dom.Table(
                    *[
